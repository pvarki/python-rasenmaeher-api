...
from rasenmaeher_api.web.api_v2 import (
    healthcheck,
    product,
    checkauth,
    enduserpfx,
...
api_router.include_router(invitecode.NO_JWT_ENROLLMENT_ROUTER, prefix="/invite-code", tags=["invite-code"])
api_router.include_router(invitecode.ENROLLMENT_ROUTER, prefix="/invite-code", tags=["invite-code"])
