...
def test_check_invalid_code(localmaeher_api: Tuple[str, str, float]) -> None:
...
def test_firstuser_is_active(localmaeher_api: Tuple[str, str, float]) -> None:
...
def test_firstuser_is_not_active(localmaeher_api: Tuple[str, str, float]) -> None:
